...
def test_append_conv2d_layer():
    model = CNN()
    model.add_input_layer(shape=(256, 256, 3), name="input0")
    model.append_conv2d_layer(10, (3, 3), activation='relu',name="test_append_conv2d_layer")
...
def test_append_dense_layer():
    model = CNN()
    model.add_input_layer(shape=(256*256*3,), name="input0")
    model.append_dense_layer(num_nodes=100, activation='relu',name="test_append_dense_layer")
    input = np.zeros((10, 256*256*3))
...
def test_get_weights_without_biases_2():
    ...
    for k in range(number_of_conv_layers):
        ...
        my_cnn.append_conv2d_layer(num_of_filters=number_of_filters,
                                   ...
                                   padding="same", activation='linear',name="test_get_weights_without_biases_2"+str(k))
...
def test_get_weights_without_biases_3():
    ...
    for k in range(number_of_conv_layers):
        ...
        my_cnn.append_conv2d_layer(num_of_filters=number_of_filters,
                                   kernel_size=kernel_size,
                                   padding="same", activation='linear',name="test_get_weights_without_biases_3"+str(k))
    ...
    for k in range(number_of_dense_layers):
        number_of_nodes = np.random.randint(3, 100)
        kernel_size = np.random.randint(3, 9)
        my_cnn.append_dense_layer(num_nodes=number_of_nodes,name="ad"+str(k))
...
def test_get_biases_1():
    ...
    for k in range(number_of_dense_layers):
        number_of_nodes = np.random.randint(3, 100)
        kernel_size= np.random.randint(3,9)
        my_cnn.append_dense_layer(num_nodes=number_of_nodes,name="test_get_biases_1"+str(k))
...
def test_get_biases_2():
    ...
    for k in range(number_of_conv_layers):
        ...
        my_cnn.append_conv2d_layer(num_of_filters=number_of_filters,
                                   kernel_size=kernel_size,
                                   padding="same", activation='linear',name="test_get_biases_2"+str(k))
...
def test_set_weights_without_biases():
    ...
    for k in range(number_of_conv_layers):
        ...
        my_cnn.append_conv2d_layer(num_of_filters=number_of_filters,
                                   kernel_size=kernel_size,
                                   padding="same", activation='linear',name="test_set_weights_without_biases"+str(k))
    ...
    my_cnn.append_maxpooling2d_layer(pool_size=pool_size, padding="same",
                                     strides=2, name="pool1")
    my_cnn.append_flatten_layer(name="flat1")
    my_cnn.append_dense_layer(num_nodes=10,name="test_set_weights_without_biases")
    number_of_dense_layers = np.random.randint(2, 10)
    previous_nodes = 10
    for k in range(number_of_dense_layers):
        number_of_nodes = np.random.randint(3, 100)
        kernel_size = np.random.randint(3, 9)
        my_cnn.append_dense_layer(num_nodes=number_of_nodes,name="test_set_weights_without_biases_2"+str(k))
